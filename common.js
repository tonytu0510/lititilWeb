...
(function() {
    ...
    const html = `
        ...
        <div id="iconGroup">
            ...
            <!-- 关闭按钮（最左边） -->
    <button class="close-btn" onclick="toggleDino()" style="position:absolute;left: 15px;top: calc(50% - 3px);transform:translateY(-50%);z-index:99999;background:none;border:none;color:#fff;cursor:pointer;font-size:14px;">✕</button>

        <!-- 小恐龙跑酷组件 -->
        <div id="dinoBar" style="position:relative;">
    <dino-game width="100%" height="50" speed="3" style="position: absolute;left: 0;top: 0;height: 100%;width: 87vw;transform: translateX(3%);"></dino-game>
