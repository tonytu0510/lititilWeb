...
(function() {
    ...
    const html = `
        ...
        <div id="iconGroup">
            ...
            <!-- 关闭按钮（最左边） -->
    <button class="close-btn" onclick="toggleDino()" style="position:absolute;left:2%;top: calc(50% - 3px);z-index:99999;background:none;border:none;color:#fff;cursor:pointer;font-size:14px;">✕</button>
